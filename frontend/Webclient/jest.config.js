...
export default {
  ...
  moduleNameMapper: {
    '\\.(css|less|scss|sass)$': 'identity-obj-proxy',
    '\\.(svg|jpg|jpeg|png|gif)$': '<rootDir>/__mocks__/fileMock.js',
    '^../lib/axios$': '<rootDir>/__mocks__/components/lib/axios.js',
    '^../../components/lib/axios$':
      '<rootDir>/__mocks__/components/lib/axios.js',
    '^../components/lib/axios$': '<rootDir>/__mocks__/components/lib/axios.js',
